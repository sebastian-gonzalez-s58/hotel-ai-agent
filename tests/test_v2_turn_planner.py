...
class V2TurnPlannerTest(unittest.TestCase):
    ...
    def test_room_service_change_preserves_destination_and_clears_old_items(self, openai_call):
        ...
        response = plan_v2_turn(use_presented_room_button(AgentTurnRequest.model_validate(request_payload), "CHANGE"))
    ...
    def test_room_service_confirmation_starts_once_with_authoritative_draft(self, openai_call):
        ...
        response = plan_v2_turn(use_presented_room_button(AgentTurnRequest.model_validate(request_payload), "CONFIRM"))
    ...
    def test_accepts_one_confirmed_room_service_start_with_configured_input(self):
        ...
        request.conversation.summary = json.dumps({"pendingOffering": "ROOM_SERVICE", "phase": "AWAITING_CONFIRMATION",
            "awaitingExplicitConfirmation": True, "capturedFields": response.toolCalls[0].arguments["input"]})
